...
var addingWatchList = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                movieData = _a.sent();
                return [4 /*yield*/, userSchema_1["default"].findOneAndUpdate({ email: user.email }, { $push: { watchedList: { WatchedMovieTitle: movieData.title } } })];
            case 3:
                updatedData = _a.sent();
